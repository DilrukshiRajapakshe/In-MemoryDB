...
import lk.sliit.dilrukshi.app.main.AppInitializer;
import lk.sliit.dilrukshi.app.view.util.OrderTM;
...
//        System.out.println("TEST : " + olOrders);
    ...
    private void tblOrders_OnClick(MouseEvent mouseEvent) throws IOException {
        if (mouseEvent.getClickCount() == 2){
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(this.getClass().getResource("/lk/sliit/dilrukshi/app/view/ViewOrderForm.fxml"));
