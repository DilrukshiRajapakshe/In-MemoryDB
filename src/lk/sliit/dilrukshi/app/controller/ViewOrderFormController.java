...
import lk.sliit.dilrukshi.app.business.BOFactory;
import lk.sliit.dilrukshi.app.business.custom.ManageCustomersBO;
...
import lk.sliit.dilrukshi.app.view.util.OrderDetailTM;
...
public class ViewOrderFormController {
    ...
    private void navigateToMain(MouseEvent mouseEvent) throws IOException {
        ...
        Parent root = FXMLLoader.load(this.getClass().getResource("/lk/sliit/dilrukshi/app/view/SearchOrderForm.fxml"));
